...
class SummaryShow extends StatefulWidget {
  String text;
  SummaryShow({super.key, required this.text});

  @override
  State<SummaryShow> createState() => _SummaryShowState();
}

class _SummaryShowState extends State<SummaryShow> {
